...
<div class="row">
    <div class="col text-center">
        ...
        <a href="{{url('pengambilan-barang/create')}}" class="btn btn-success">Create vendor</a>
            ...
            <li class="splide__slide">
                <div class="card splide__slide" style="width:25rem; margin:0 5px;">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <p class="font-weight-bold">Nomor ID Vendor : {{$dt->id_request_order}}</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p class="font-weight-bold">Nomor ID Bahan Baku : {{$dt->tanggal_pengambilan_barang}}</p>
                        </div>
