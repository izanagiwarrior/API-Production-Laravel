...
<div class="row">
    <div class="col text-center">
        ...
        <a href="{{url('/order/create')}}" class="btn btn-success">Create vendor</a>
            ...
            <li class="splide__slide">
                <div class="card splide__slide" style="width:25rem; margin:0 5px;">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <p class="font-weight-bold">Nama Request : {{$dt->jumlah_bahan_baku}}</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p class="font-weight-bold">Nama Request : {{$dt->harga}}</p>
                        </div>
                    </div>
