                ...
                <div class="card-body">
                    <form action="{{route('createTransaksi')}}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" name="id_request_order" placeholder="Password">
                        </div>
                        <!-- input id vendor -->
                        <div class="form-group mb-3">
                            <label for="exampleInputPassword1">ID Vendor</label>
                            <input type="number" class="form-control" name="id_vendor" placeholder="Password">
                        </div>
                        <!-- input nomor resi -->
                        <div class="form-group mb-3">
                            <label for="exampleInputPassword1">Nomor Resi</label>
                            <input type="text" class="form-control" name="nomor_resi" placeholder="Password">
                        </div>
                        <!-- input nomor transaksi -->
                        <div class="form-group mb-3">
                            <label for="exampleInputPassword1">Nomor Transaksi</label>
                            <input type="text" class="form-control" name="nama_transaksi" placeholder="Password">
                        </div>
                        <!-- input tanggal transaksi -->
                        <div class="form-group mb-3">
                            <label for="exampleInputPassword1">Tanggal Transaksi</label>
                            <input type="date" class="form-control" name="tanggal_transaksi" placeholder="Password">
                        </div>
                        <!-- input total harga -->
                        <div class="form-group mb-3">
                            <label for="exampleInputPassword1">Total Harga</label>
                            <input type="number" class="form-control" name="total_harga" placeholder="Password">
                        </div>
