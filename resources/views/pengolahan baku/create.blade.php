            ...
            <div class="card mx-auto" style="width: 30rem;">
                ...
                <form action="{{route('createPengolahan')}}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" name="id_vendor" placeholder="enter here">
                        </div>
                        <!-- input nomor resi -->
                        <div class="form-group mb-3">
                            <label for="exampleInputenter here1">Jenis Bahan Baku</label>
                            <input type="text" class="form-control" name="jenis_bahan_baku" placeholder="enter here">
                        </div>
                        <!-- input nomor transaksi -->
                        <div class="form-group mb-3">
                            <label for="exampleInputenter here1">Nama Bahan Baku</label>
                            <input type="text" class="form-control" name="nama_bahan_baku" placeholder="enter here">
                        </div>
                        <!-- input tanggal transaksi -->
                        <div class="form-group mb-3">
                            <label for="exampleInputenter here1">Harga Bahan Baku</label>
                            <input type="number" class="form-control" name="harga_bahan_baku" placeholder="enter here">
                        </div>
                        <!-- input total harga -->
                        <div class="form-group mb-3">
                            <label for="exampleInputenter here1">Jumlah Bahan Baku</label>
                            <input type="number" class="form-control" name="jumlah_bahan_baku" placeholder="enter here">
                        </div>
